...
public class NewChangeText extends Transition {
     ...
     */
    public NewChangeText setChangeBehavior(int changeBehavior) {
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues,
        ...
        if (!startText.equals(endText)) {
            ...
            if (mChangeBehavior == CHANGE_BEHAVIOR_KEEP) {
                ...
                // Fade out start text
                ValueAnimator outAnim = null, inAnim = null, scrollAnimUp = null, scrollAnimDown = null;
                if (mChangeBehavior == CHANGE_BEHAVIOR_OUT_IN ||
                    ...
                    scrollAnimUp = ValueAnimator.ofFloat(0, -view.getHeight() * 0.5f);
                    scrollAnimUp.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    scrollAnimUp.addListener(new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationEnd(Animator animation) {
                            super.onAnimationEnd(animation);
                        }
                    });
                    scrollAnimDown = ValueAnimator.ofFloat(view.getHeight() * 0.5f, 0);
                    scrollAnimDown.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public void onAnimationUpdate(ValueAnimator animation) {
                            view.setTranslationY((Float) animation.getAnimatedValue());
                    ...
                    scrollAnimDown.addListener(new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationEnd(Animator animation) {
                            super.onAnimationEnd(animation);
                        }
                ...
                if (outAnim != null && inAnim != null) {
                    ...
                    setOut.playTogether(scrollAnimUp, outAnim);
                    AnimatorSet setIn = new AnimatorSet();
                    setIn.playTogether(scrollAnimDown, inAnim);

                    anim.setDuration(100);
                    ((AnimatorSet) anim).playSequentially(setOut, setIn);
